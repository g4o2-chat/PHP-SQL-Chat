...
<body style="margin-left: 30px;">
    ...
    <p>These terms and conditions outline the rules and regulations for the use of g4o2's Website, located at
        https://php-sql-chat.maxhu787.repl.co.</p>

    <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use g4o2 if you do not
    ...
    <p>We employ the use of cookies. By accessing g4o2, you agreed to use cookies in agreement with the g4o2's Privacy
        Policy. </p>
    ...
    <p>Unless otherwise stated, g4o2 and/or its licensors own the intellectual property rights for all material on g4o2. All
        intellectual property rights are reserved. You may access this from g4o2 for your own personal use subjected to
        restrictions set in these terms and conditions.</p>

    <p>You must not:</p>
    <ul>
        <li>Republish material from g4o2</li>
        <li>Sell, rent or sub-license material from g4o2</li>
        <li>Reproduce, duplicate or copy material from g4o2</li>
        <li>Redistribute content from g4o2</li>
    </ul>
    ...
    <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas
        of the website. g4o2 does not filter, edit, publish or review Comments prior to their presence on the website.
        Comments do not reflect the views and opinions of g4o2,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent permitted by applicable laws, g4o2 shall not
        be liable for the Comments or for any liability, damages or expenses caused and/or suffered as a result of any use
        of and/or posting of and/or appearance of the Comments on this website.</p>

    <p>g4o2 reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate,
    ...
    <p>You hereby grant g4o2 a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit
        any of your Comments in any and all forms, formats or media.</p>
    ...
    <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
        ...
        with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of g4o2; and (d) the
    ...
    <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you
        must inform us by sending an e-mail to g4o2. Please include your name, your organization name, contact information
    ...
    <p>No use of g4o2's logo or other artwork will be allowed for linking absent a trademark license agreement.</p>
    ...
    <p>Please read <a href="./privacy-policy.php" target="_blank">Privacy Policy</a></p>
